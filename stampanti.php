...
//mysql_select_db("fm_consumabili", $con);
...
<form  action="<?php $_SERVER['PHP_SELF'];?>" method="GET">
    ...
    <label for='stampanti'>Scegli una stampante e conferma :</label>
...
<form  action="ordine.php" method="GET">
    <table>
        ...
        echo ("</table>");
        echo("<input type='hidden' name='idStampante' value='".$_REQUEST['idStampante']."'>");
